  ...
  function ProductDetail() {
    const { handleClose, selectedProduct, handelAddToCart } = useContext(ProductContext);
            ...
            <div className="bg-white text-black shadow-md dark:bg-[#12141D] dark:text-white rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
              ...
              <div className="p-5 lg:p-11">
                ...
                <div className="grid lg:grid-cols-2 gap-2">
                  <a className="bg-primary rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#171923] font-semibold text-sm" href="#" onClick={(e) => handelAddToCart(e, selectedProduct)}>
